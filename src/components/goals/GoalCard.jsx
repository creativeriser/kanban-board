  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn(
          'group cursor-grab select-none rounded-xl border border-border/60 bg-surface/80 backdrop-blur-md shadow-card dark:shadow-dark-card active:cursor-grabbing',
          'hover:border-ink-200 hover:bg-surface hover:shadow-raised dark:hover:shadow-dark-raised transition-all duration-200',
